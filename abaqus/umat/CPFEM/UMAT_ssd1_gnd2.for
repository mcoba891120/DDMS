...
C              TERM1=PROP(2)*PROP(3)*PROP(4)/2
C              TERM2=RHOS+RHOG
C              TERM3=PROP(5)*SQRT(RHOS)-PROP(6)*RHOS
C              TERM4=PROP(12)-PROP(13)*RHOG
C              TERM5=(PROP(5)/2/SQRT(RHOS)-PROP(6))*TERM3
C              TERM6=PROP(13)*TERM4

C              TEMP1=-0.5*TERM2**(-1.5)*(TERM3+TERM4)**2
C              TEMP2=TERM2**(-0.5)*(TERM5-TERM6)

C              DHSELF=TERM1*(TEMP1+TEMP2)
CFIXB
           RETURN
           END
