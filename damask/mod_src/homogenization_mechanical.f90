...
module subroutine mechanical_init(num_homog)
  ...
  print'(/,a)', ' <<<+-  homogenization:mechanical_MOD init  -+>>>'
...
module subroutine mechanical_homogenize(dt,ce)
  ...
  ! if (ce == 1) then
  !   print '(/,a)', ' <<<+- running mechanical_homogenize  -+>>>'
  !   print *, 'homogenization_Nconstituents' , homogenization_Nconstituents(material_homogenizationID(ce))
  !   print *, homogenization_dPdF(1:3,1:3,1:3,1:3,ce) - phase_mechanical_dPdF(dt,1,ce)
  ! endif
